...
public class EmprestimoDAO {
   ...
   public List<View_HistoricoEmprestimo> vw_HistoricoEmprestimos(String filtroMatricula, String filtroNomeItem) throws SQLException {
        ...
        String sql = "SELECT * FROM vw_historico_emprestimos WHERE 1 = 1 ";
        ...
        while (rs.next()) {
            View_HistoricoEmprestimo historico = new View_HistoricoEmprestimo();
                historico.setResponsavel(rs.getString("Responsável"));
                historico.setMatriculaUsuario(rs.getString("Matricula"));
                historico.setItem(rs.getString("Item"));
                historico.setStatus(rs.getString("Status"));
                historico.setDataAtualizacao(rs.getTimestamp("Atualização"));
